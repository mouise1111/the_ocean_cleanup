...
import { setGlobalState } from "../Minigame/globalstate";
...
const Leaderboard = ({ onStopClick }) => {
  ...
  return (
    <div className="absolute px-4 py-2 border-8 left-5 bottom-5 border-amber-300 bg-amber-100 rounded-3xl">
      ...
      <button
        ...
        className="px-4 py-2 mt-4 text-lg text-white bg-red-500 rounded-lg"
      >
        Stop Game
      </button>
    </div>
